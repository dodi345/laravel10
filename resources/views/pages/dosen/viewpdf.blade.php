                ...
                <div class="row d-flex align-items-baseline">
                    ...
                    <div class="col-xl-3 float-end">
                        <a data-mdb-ripple-init class="btn btn-light text-capitalize border-0"
                            data-mdb-ripple-color="dark" href="{{ route('invoice.pdf') }}"><i class="fas fa-print text-primary"></i> Print</a>
                        ...
                        <div class="col-xl-4">
                            ...
                            <ul class="list-unstyled">
                                <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                                        class="fw-bold">ID:</span>#9489184-189183</li>
                                <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2">
                            <button type="button" data-mdb-button-init data-mdb-ripple-init
                                class="btn btn-primary text-capitalize" style="background-color:#60bdf3 ;">Pay
                                Now</button>
                        </div>
                    </div>
